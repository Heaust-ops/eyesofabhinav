...
plane.material.bumpMap.repeat.x = 5.0;
plane.material.bumpMap.repeat.y = 5.0;
plane.material.bumpMap.wrapS = base.Wrapping.RepeatWrapping;
plane.material.bumpMap.wrapT = base.Wrapping.RepeatWrapping;
let boxes = [];
let coords = [];
...
// base.skybox("./resources/skyboxes/sk.jpg");
